...
var stripeWebhookHandler = function (req, res) {
    ...
    return __generator(this, function (_c) {
      switch (_c.label) {
        case 0:
          ...
          try {
            event = strip_1.stripe.webhooks.constructEvent(
              body,
              signature,
          ...
          if (
            !((_a =
              session === null || session === void 0
                ? void 0
                : session.metadata) === null || _a === void 0
              ? void 0
              : _a.userId) ||
            !((_b =
              session === null || session === void 0
                ? void 0
                : session.metadata) === null || _b === void 0
              ? void 0
              : _b.orderId)
          ) {
            return [
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            resend.emails.send({
              from: "DigitalMarketBy Turja <hello@joshtriedcoding.com>",
              to: [user.email],
