...
var ReceiptEmail = function (_a) {
  ...
  var total =
    products.reduce(function (acc, curr) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          components_1.Section,
          { style: informationTable },
          React.createElement(
            components_1.Row,
            { style: informationTableRow },
            React.createElement(
              components_1.Column,
              ...
              React.createElement(
                components_1.Link,
                { style: __assign({}, informationTableValue) },
                email
              )
            ),
            React.createElement(
        ...
        products.map(function (product) {
          ...
          return React.createElement(
              ...
              product.description
                ? React.createElement(
                    ...
                    product.description.length > 50
                      ? ((_a = product.description) === null || _a === void 0
                          ? void 0
                          : _a.slice(0, 50)) + "..."
                      : product.description
                  )
            ...
            React.createElement(
              components_1.Column,
              { style: productPriceWrapper, align: "right" },
              React.createElement(
                components_1.Text,
                { style: productPrice },
        ...
        React.createElement(
          components_1.Section,
          null,
          React.createElement(components_1.Column, {
            style: { width: "64px" },
          }),
          React.createElement(
            components_1.Column,
        ...
        React.createElement(
          ...
          React.createElement(
            components_1.Column,
            { style: tableCell, align: "right" },
            React.createElement(
              components_1.Text,
              { style: productPriceTotal },
              "TOTAL"
            )
          ),
          React.createElement(components_1.Column, {
          ...
          React.createElement(
            components_1.Column,
            { style: productPriceLargeWrapper },
            React.createElement(
              components_1.Text,
              { style: productPriceLarge },
              (0, utils_1.formatPrice)(total)
            )
          )
        ),
        ...
        React.createElement(
          ...
          "Copyright \u00A9 2023 DigitalMarket Inc. ",
...
var ReceiptEmailHtml = function (props) {
  return (0, components_1.render)(
    React.createElement(exports.ReceiptEmail, __assign({}, props)),
    {
      pretty: true,
    }
  );
...
var informationTableLabel = __assign(__assign({}, resetText), {
...
var productTitleTable = __assign(__assign({}, informationTable), {
...
var productDescription = __assign(
  { fontSize: "12px", color: "rgb(102,102,102)" },
  resetText
);
var productLink = {
  fontSize: "12px",
